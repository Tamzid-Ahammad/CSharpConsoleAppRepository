...
namespace ConsoleAppRepository
{
    ...
    public sealed class ContactRepository : IRepository<Contact>
    {
        ...
        public static ContactRepository Instance//to imeplement singleton pattern
        {
            get
            {
                _instance = _instance ?? new ContactRepository();
                return _instance;
            }
        }
        ...
        IEnumerable<Contact> IRepository<Contact>.Data { get => this.Data; }
